...
{
    private readonly ILanguageAppService _sampleAppService;
    private readonly IIdentityModelAuthenticationService _authenticationService;
    private readonly IConfiguration _configuration;

    public ClientDemoService(
        ILanguageAppService sampleAppService,
    ...
    private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            var url = _configuration["RemoteServices:LanguageModule:BaseUrl"] +
                      "api/LanguageModule/sample/authorized";
