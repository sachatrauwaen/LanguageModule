...
using Satrabel.LanguageModule.Blazor.Server.Host.Menus;
...
[DependsOn(
    ...
    typeof(LanguageModuleBlazorServerModule)
)]
public class LanguageModuleBlazorHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(LanguageModuleResource),
               /* typeof(LanguageModuleDomainModule).Assembly,*/
                typeof(LanguageModuleDomainSharedModule).Assembly,
                typeof(LanguageModuleApplicationModule).Assembly,
                typeof(LanguageModuleApplicationContractsModule).Assembly,
                typeof(LanguageModuleBlazorHostModule).Assembly
            );
        });
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("LanguageModule");
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles("/Satrabel.LanguageModule.Blazor.Server.Host.styles.css");
                }
            );
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
               ...
               */ options.FileSets.ReplaceEmbeddedByPhysical<LanguageModuleApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, string.Format("..{0}..{0}src{0}Satrabel.LanguageModule.Application.Contracts", Path.DirectorySeparatorChar)));
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<LanguageModuleBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
        ...
        {
            options.AppAssembly = typeof(LanguageModuleBlazorHostModule).Assembly;
        });
    ...
    public override async Task OnApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "LanguageModule API");
        });
