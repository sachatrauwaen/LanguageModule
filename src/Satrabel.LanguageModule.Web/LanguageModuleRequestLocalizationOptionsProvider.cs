...
public class LanguageModuleRequestLocalizationOptionsProvider : IAbpRequestLocalizationOptionsProvider //, ISingletonDependency
{
    ...
    public LanguageModuleRequestLocalizationOptionsProvider(IServiceScopeFactory serviceProviderFactory, IOptions<AbpLocalizationOptions> options)
    {
            ...
            using (await _syncSemaphore.LockAsync())
            {
                if (_requestLocalizationOptions == null)
                {
                    using (var serviceScope = _serviceProviderFactory.CreateScope())
                    {
                        ...
                        var languages = _options.Value.Languages;
